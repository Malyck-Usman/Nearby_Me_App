 ...
 */
public class fragment_allowed_users extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_allowed_users, container, false);


        mDBRef = FirebaseFirestore.getInstance();

        InitViews(view);
        mDBRef.collection("users").whereEqualTo("status",true).get()
    ...
    private void InitViews(View view) {
        mRecyclerView=view.findViewById(R.id.rv_admin_allowed_users);
