...
import com.example.nearbyme.Model.Item_adapter;
 ...
 */
public class fragment_buy_sell extends Fragment implements OnMapReadyCallback,View.OnClickListener,SeekBar.OnSeekBarChangeListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mItemAdapter = new Item_adapter(getContext(), mItemList);
        ...
        getChildFragmentManager().beginTransaction().add(R.id.container_map_buy, supportMapFragment).commit();
    ...
    private void InitViews(View view) {
        sb_Radius = view.findViewById(R.id.sb_radius_buy);
        sb_Radius.setOnSeekBarChangeListener(this);
        edt_Radius = view.findViewById(R.id.edt_radius_buy);
        btn_Find_Location = view.findViewById(R.id.btn_find_location_buy);
        btn_Search = view.findViewById(R.id.btn_search_buy);
        btn_Find_Location.setOnClickListener(this);
        btn_Search.setOnClickListener(this);

        mRecyclerView = view.findViewById(R.id.rv_buy);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        constraintlayout = view.findViewById(R.id.constraint_layout_buy);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_find_location_buy:
            {
                ...
                mLocationClient.getLastLocation().addOnCompleteListener((Task<Location> task) -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (location != null) {
                            ...
                            mItemAdapter.getItemLatLng(User_Lat, User_Lon);
                        ...
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                for (QueryDocumentSnapshot qds : queryDocumentSnapshots) {
                                    String Itemid=qds.getId();
                                    Item_info getItemInfo = qds.toObject(Item_info.class);
                                    getItemInfo.setItem_id(Itemid);
                                    double ResultLatitude = getItemInfo.getLatitude();
                                    double ResultLongitude = getItemInfo.getLongitude();
                                    ...
                                    if (distance <= radius) {
                                        ...
                                        generator.setBackground(getActivity().getDrawable(R.drawable.marker_icon_buy));
    ...
    private void changeConstOfMap() {
        ...
        constraintSet.connect(R.id.container_map_buy, ConstraintSet.BOTTOM, R.id.rv_buy, ConstraintSet.TOP, 0);
