 ...
 */
public class fragment_homestores extends Fragment implements OnMapReadyCallback,View.OnClickListener,SeekBar.OnSeekBarChangeListener {
    ...
    private HomeStore_Adapter mHomeStoreAdapter;
    private List<Home_Store_info> mHomeStoreList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null) {
            view = inflater.inflate(R.layout.fragment_homestores, container, false);

            InitViews(view);

            mHomeStoreList = new ArrayList<>();
            mHomeStoreAdapter = new HomeStore_Adapter(getContext(), mHomeStoreList);
            mRecyclerView.setAdapter(mHomeStoreAdapter);
            ...
            getChildFragmentManager().beginTransaction().add(R.id.container_map_homestore, supportMapFragment).commit();
    ...
    private void InitViews(View view) {
        sb_Radius = view.findViewById(R.id.sb_radius_homestore);
        sb_Radius.setOnSeekBarChangeListener(this);
        edt_Radius = view.findViewById(R.id.edt_radius_homestore);
        btn_Find_Location = view.findViewById(R.id.btn_find_location_homestore);
        btn_Search = view.findViewById(R.id.btn_search_homestore);
        btn_Find_Location.setOnClickListener(this);
        btn_Search.setOnClickListener(this);

        mRecyclerView = view.findViewById(R.id.rv_homestore);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        constraintlayout = view.findViewById(R.id.constraint_layout_homestore);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_find_location_homestore:
                {
                ...
                mLocationClient.getLastLocation().addOnCompleteListener((Task<Location> task) -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (location != null) {
                            ...
                            mHomeStoreAdapter.getHomeStoreLatLong(User_Lat, User_Lon);
            ...
            break;
            case R.id.btn_search_homestore:
                ...
                mDBRef.collection("store").get()
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                mHomeStoreList.clear();

                                s_no = 1;
                                for (QueryDocumentSnapshot qds : queryDocumentSnapshots) {
                                    String homestore_id=qds.getId();
                                    Home_Store_info getHomeStoreInfo = qds.toObject(Home_Store_info.class);
                                    getHomeStoreInfo.setHomestore_id(homestore_id);
                                    double ResultLatitude = getHomeStoreInfo.getLatitude();
                                    double ResultLongitude = getHomeStoreInfo.getLongitude();
                                    ...
                                    if (distance <= radius) {
                                        ...
                                        mHomeStoreList.add(getHomeStoreInfo);
                                        s_no++;
                                    }

                                }
                                if (mHomeStoreList == null) {
                                ...
                                mHomeStoreAdapter.notifyDataSetChanged();
                            }
    ...
    private void changeConstOfMap() {
        ...
        constraintSet.connect(R.id.container_map_homestore, ConstraintSet.BOTTOM, R.id.rv_homestore, ConstraintSet.TOP, 0);
