...
import com.example.nearbyme.Model.Announcement_adapter;
 ...
 */
public class fragment_announcement extends Fragment implements OnMapReadyCallback,View.OnClickListener,SeekBar.OnSeekBarChangeListener {
    ...
    private Announcement_adapter mAnnAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setActionBarTitle("Announcement");
        if(view==null) {
            view = inflater.inflate(R.layout.fragment_announcement, container, false);
            InitViews(view);

            mAnnList = new ArrayList<>();
            mAnnAdapter = new Announcement_adapter(getContext(), mAnnList);
            ...
            getChildFragmentManager().beginTransaction().add(R.id.container_map_announcement, supportMapFragment).commit();
    ...
    private void InitViews(View view) {
        sb_Radius = view.findViewById(R.id.sb_radius_announcement);
        sb_Radius.setOnSeekBarChangeListener(this);
        edt_Radius = view.findViewById(R.id.edt_radius_announcement);
        btn_Find_Location = view.findViewById(R.id.btn_find_location_announcement);
        btn_Search = view.findViewById(R.id.btn_search_announcement);
        btn_Find_Location.setOnClickListener(this);
        btn_Search.setOnClickListener(this);

        mRecyclerView = view.findViewById(R.id.rv_announcement);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        constraintlayout = view.findViewById(R.id.constraint_layout_announcement);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_find_location_announcement:
            {
                ...
                mLocationClient.getLastLocation().addOnCompleteListener((Task<Location> task) -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (location != null) {
                            ...
                            mAnnAdapter.getItemLatLng(User_Lat, User_Lon);
            ...
            break;
            case R.id.btn_search_announcement:
                        ...
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                for (QueryDocumentSnapshot qds : queryDocumentSnapshots) {
                                    Announcement_info getAnnInfo = qds.toObject(Announcement_info.class);
                                    getAnnInfo.setAnn_id(qds.getId());
                                    double ResultLatitude = getAnnInfo.getLatitude();
                                    double ResultLongitude = getAnnInfo.getLongitude();
                                    ...
                                    if (distance <= radius) {
                                        ...
                                        generator.setBackground(getActivity().getDrawable(R.drawable.marker_icon_announcement));
    ...
    private void changeConstOfMap() {
        ...
        constraintSet.connect(R.id.container_map_announcement, ConstraintSet.BOTTOM, R.id.rv_announcement, ConstraintSet.TOP, 0);
